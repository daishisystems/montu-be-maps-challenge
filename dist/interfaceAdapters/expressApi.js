...
var app = (0, express_1.default)(); // Explicitly define the Express application type
var port = 3000;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!query) {
                    ...
                    return [2 /*return*/]; // Ensure function always returns
                }
                return [4 /*yield*/, service.getAddressSuggestions(query)];
            case 1:
                addresses = _a.sent();
                res.json(addresses);
                return [3 /*break*/, 3];
...
app.listen(port, function () { return console.log("Server running at http://localhost:".concat(port)); });
